...
import fr.ippon.iroco2.domain.estimateur.exception.GlobalEnergyMixNotFound;
import fr.ippon.iroco2.domain.estimateur.model.EstimatableServer;
import fr.ippon.iroco2.domain.estimateur.model.MemoryConfig;
import fr.ippon.iroco2.domain.estimateur.model.cpu.RealCPUConfig;
import fr.ippon.iroco2.domain.estimateur.model.cpu.ServerlessCPUConfig;
...
import static fr.ippon.iroco2.domain.calculateur.model.Component.LAMBDA_SERVICE_SHORT_NAME;
...
import static fr.ippon.iroco2.domain.estimateur.TimeConstant.MS_IN_ONE_DAY;
import static fr.ippon.iroco2.domain.estimateur.TimeConstant.MS_IN_ONE_MONTH;
import static fr.ippon.iroco2.domain.estimateur.aws.EC2Instance.TDP_TO_POWER_CONSUMPTION_RATIO;
import static fr.ippon.iroco2.domain.estimateur.model.MemoryConfig.ZERO_MB;
import static fr.ippon.iroco2.domain.estimateur.model.cpu.CPUType.EPYC;
import static fr.ippon.iroco2.domain.estimateur.model.cpu.CPUType.XEON;
