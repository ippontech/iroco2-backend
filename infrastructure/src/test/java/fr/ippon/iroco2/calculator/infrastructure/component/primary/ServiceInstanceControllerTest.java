...
class ServiceInstanceControllerTest extends TestContainersPostgresqlConfig {
    ...
    void should_get_all_and_only_ec2_instance() throws Exception {
        var resultActions = mockMvc.perform(get("/api/awsInstanceType").queryParam("serviceShortName", "EC2"));
        resultActions.andExpect(status().isOk())
                .andExpect(jsonPath("$.length()", CoreMatchers.is(650)));
    }
}