...
UPDATE services SET limitation = 'Le transfert de données (inbound/outbound) n''est pas pris en compte pour le moment' where services.name='Amazon Elastic File System (EFS)';
UPDATE services SET lever = 'Mise en place d''une policy d''archivage des données vers d''autre Tier (Infrequent Access, etc...)
' where services.name='Amazon Elastic File System (EFS)';
...
UPDATE services SET limitation = 'Le transfert de données (inbound/outbound) n''est pas pris en compte pour le moment\nSeulement DynamoDB On-Demand est pris en charge pour le moment' where services.name='Amazon DynamoDB';
UPDATE services SET lever = 'Utilisation d''Auto scaling pour la provisioned capacity\nChoisir la bonne classe de stockage (standard, infrequent, etc...)' where services.name='Amazon DynamoDB';

UPDATE services SET limitation = 'Le transfert de données (inbound/outbound) n''est pas pris en compte pour le moment\nRedshift Serverless n''est pas pris en compte pour le moment' where services.name='Amazon Redshift';
UPDATE services SET lever = 'Utilisation d''Auto scaling pour la provisioned capacity\nRight Sizing pour choisir le type d''instance adapté à votre besoin' where services.name='Amazon Redshift';

UPDATE services SET lever = 'Optimisation du code source pour réduire un maximum le temps d''éxécution\nRight Sizing des ressources allouées aux Lambda' where services.name='AWS Lambda';
