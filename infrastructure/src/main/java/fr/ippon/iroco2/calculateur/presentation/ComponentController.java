...
public class ComponentController {
    ...
    public static final ComponentMapper COMPONENT_MAPPER = Mappers.getMapper(ComponentMapper.class);
    ...
    public ResponseEntity<List<ComponentResponse>> findAllByInfrastructureID(@RequestParam("infrastructureId") @Valid @NotNull UUID infrastructureId) {
        ...
        List<ComponentResponse> response = COMPONENT_MAPPER.toResponse(components);
