...
public class ServiceInstanceController {
    private final ServiceInstanceSvc serviceInstanceSvc;
    ...
    public ResponseEntity<List<InstanceTypeDTO>> getCompatibleInstancesForService(@RequestParam("serviceShortName") String serviceShortName) {
        List<InstanceTypeDTO> list = serviceInstanceSvc.getNamesOfCompatibleInstancesForService(serviceShortName)
                .stream()
                .map(InstanceTypeDTO::new)
                .toList();
